...
$$\text{Genes X: } \ \ \frac{dX}{dt} = [\beta*P(S > \kappa_S) - \alpha * X]$$
$$\text{Genes Y: } \ \ \frac{dY}{dt} = [\beta*P(X* > \kappa_X) - \alpha * Y]$$
...
The benefits of this is that the visuals are usually easier to work with and, crucially, are more intellectually tractable for any stakeholders that don't have mathematical training.
