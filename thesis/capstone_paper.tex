...
\color{blue}
Category theory is the tall tower of mathematics.
From its high vantage point it's possible to see the patterns that repeat across the panorama of mathematical fields: from group theory to linear algebra to topology.
