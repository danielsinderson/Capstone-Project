...
\begin{definition}[Isomorphism]
    Two objects in a category are isomorphic if there exists a morphism $f:a\rightarrow b$ for which there is another morphism $f^{-1}:b\rightarrow a$ such that $f^{-1}\circ f=id_a$ and $f\circ f^{-1}=id_b$.
...
We'll start with three types of morphisms that tell us something about the objects that they map between.




\subsubsection*{Universal Objects / Properties}
...
The simplest such property is that of a terminal object.
