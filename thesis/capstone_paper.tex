...
It's also useful.
Category theory helps us structure our thinking by finding and giving a name to those patterns and abstractions common to mathematics, science, engineering, and linguistics.
\color{black}
...
\begin{definition}[Monad]
    ...
    \begin{enumerate}
        ...
        \item $\mu: TT \rightarrow T$ called the multiplication.
    \end{enumerate}
    ...
    These commutative diagrams with the natural transformations $\eta$ and $\mu$ create a kind of monoidal structure on the collection of endofunctors $M, MM, MMM, etc.$.
\end{definition}
\color{black}
...
\begin{definition}[Lenses]
    ...
    \[
        \begin{pmatrix}f^{\#}\\f\end{pmatrix}:\begin{pmatrix}A^-\\A^+\end{pmatrix}\rightarrow\begin{pmatrix}B^-\\B^+\end{pmatrix}
    \]
\end{definition}
\color{black}
