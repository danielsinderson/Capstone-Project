...
But it will also include some structures that might seem strange and perplexing at first: representability, adjunctions, and monads.
...
But it's not surjective on objects since there's no object in $\mathcal{C}$ that maps to $y$ in $\mathcal{D}$.
...
\subsection*{Categories of Cones and Comma Categories}
