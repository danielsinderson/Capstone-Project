...
\\
And that's it.
The reason duality turns out to be so powerful is that it essentially doubles our effectiveness.
...
\begin{definition}[Isomorphism]
    We say that two objects in a category are isomorphic if there exists a morphism $f:a\rightarrow b$ for which there is another morphism $f^{-1}:b\rightarrow a$ such that $g\circ f=id_b$ and $f\circ g=id_a$.
